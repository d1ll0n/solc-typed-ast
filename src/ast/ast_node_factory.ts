...
interface StaticNodeFactory extends BaseStaticNodeFactory {
    ...
    makeLiteralNumber(ctx: ASTContext, n: string | number): Literal;
...
export class ASTNodeFactory {
    ...
    makeLiteralUint256(value: string | number): Literal {
        return makeLiteralNumber(this.context, value);
    }
...
function makeTypeNameUint(ctx: ASTContext, size: number): ElementaryTypeName {
...
function makeLiteralNumber(ctx: ASTContext, n: string | number): Literal {
...
function makeConstantUint256(
    ...
    return makeConstant(ctx, name, makeTypeNameUint256(ctx), makeLiteralNumber(ctx, value), scope);
}
